...
const variants = cva(
	"inline-flex border  items-center justify-center overflow-hidden rounded-full",
	{
		variants: {
			...
			color: {
				primary: "bg-primary-500 text-primary-500f border-primary-500",
				secondary: "bg-secondary-500 text-secondary-500f border-secondary-500",
				light: "bg-white text-gray-900  border-gray-500f",
				dark: "bg-gray-900 text-gray-900f border-gray-900",
